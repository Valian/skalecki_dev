defmodule SkaleckiDevWeb.BlogLive.Show do
        ...
        <div class="max-w-4xl mx-auto px-6 flex justify-between items-center">
          ...
          <div class="flex gap-6 items-center">
            <div class="hidden sm:flex gap-8 text-sm font-mono text-secondary">
              ...
              <.link navigate={~p"/blog"} class="hover:text-base-content transition-colors">
                Thoughts
              </.link>
      ...
      <main class="font-sans pt-32 pb-24 px-6 max-w-3xl mx-auto min-h-screen">
        ...
        >
          <div :if={@prev_post} class="group">
            ...
            <.link
              navigate={~p"/blog/#{@prev_post.slug}"}
          ...
          <div :if={@next_post} class="group md:text-right md:col-start-2">
            ...
            <.link
              navigate={~p"/blog/#{@next_post.slug}"}
